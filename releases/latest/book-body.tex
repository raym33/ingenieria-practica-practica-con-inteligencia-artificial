...
\section{14.30 Reglas para producto
...
\section{14.31 Reglas para proyectos
...
\section{14.32 Reglas para costes}\label{reglas-para-costes}
...
\section{14.34 Reglas para prompts}\label{reglas-para-prompts}
...
\section{14.35 Reglas para evaluación}\label{reglas-para-evaluaciuxf3n}
...
\section{14.36 Reglas para datos
...
\section{14.38 Reglas para commits}\label{reglas-para-commits}
...
\section{14.39 Reglas para pull
...
\section{14.40 Reglas para ``no hacer''}\label{reglas-para-no-hacer}
...
\section{14.41 Cómo introducir reglas en un repo
...
\section{14.42 Cómo saber si las reglas
...
\section{14.43 Reglas cortas vs reglas
...
\section{14.44 Reglas y jerarquía}\label{reglas-y-jerarquuxeda}
...
\section{14.45 Reglas para este libro}\label{reglas-para-este-libro}
...
\section{14.46 Plantilla AGENTS.md para este
...
\section{14.47 Antipatrones}\label{antipatrones-3}
...
\section{14.49 Checklist práctica}\label{checklist-pruxe1ctica-13}
...
\section{14.50 Qué puede cambiar en el
...
\subsection{Arquitectura mínima}\label{arquitectura-muxednima-1}
...
\subsection{Arquitectura mínima}\label{arquitectura-muxednima-2}
...
\subsection{Arquitectura mínima}\label{arquitectura-muxednima-3}
...
\subsection{Arquitectura mínima}\label{arquitectura-muxednima-4}
...
\subsection{Arquitectura mínima}\label{arquitectura-muxednima-5}
...
\section{Latencia}\label{latencia-5}
